...
namespace Assets.Scripts
{
    public class CameraController : Singleton<CameraController>
    {
        ...
        void Update()
        {
            ...
            /*
            var deltaRot = Quaternion.Angle(transform.rotation, _targetRotation);
            if (deltaRot > 0)
            {
                var t = Mathf.SmoothDampAngle(deltaRot, 0.0f, ref _angularVelocity, RotationTime);
                transform.rotation = Quaternion.RotateTowards(transform.rotation, _targetRotation, 1.0f - t / deltaRot);
            }*/
